Feature: Consumer
    ...
    Background:
        Given I am logged into the application with user "myappssolutions666@gmail.com" and password "password"
...
#       And I click the "Logout" element
    ...
    Scenario: Verify Filter Options in Search Page
        ...
        Then I enter "10" in the "Minpriceperday " field
 ...
 #    Then I enter ".*" in the "Enddate" field
        Then I select "Power Backup" from the "SelectAmenities" dropdown
        And I click the "submit" button
    ...
    Scenario: Verify Add Attendees
        ...
        And I enter "Interview Team1" in the "Team Name" field
...
#        Then the message "Team details updated successfully." should be displayed
    ...
    Scenario: Verify Edit Profile_Name Change
        ...
        And I enter "Suk" in the "Name" field
        And I click the "Update1" button
#        Then the message "User updated successfully" should be displayed
    ...
    Scenario: Verify Add & Remove Favorites
        ...
        Then I select the facility "conf CMR"
...
#        Then the message "Favorities removed successfully." should be displayed
    ...
    Scenario: Verify Book a Coworking Facility with Valid Timings & No. of seats
        ...
        Then I select the facility "cowork C"
#        And I enter "2018-06-30 09:00:00" in the "Start Date Calendar" field
#        And I enter "2018-06-30 18:00:00" in the "End Date Calendar" field
        And I click the "Start date" element
        When I click the "5" element
...
#      | Add Meeting Details                    |
        ...
        And I select "Interview Team1" from the "team" dropdown
        And I click the "Save" button
#        And I click "OK" in the confirmation box
    ...
    Scenario: Verify Book a Coworking Facility with InValid Timings
        ...
        And I click the "submit" button
        And I wait "6" seconds
        Then I select the facility "Co-Work@1"
        And I enter "2018-03-13 17:00:00" in the "Start date" field
        And I enter "2018-03-13 18:00:00" in the "End Date" field
    ...
    Scenario: Verify Book a Coworking Facility with Invalid No. of seats
        ...
        And I wait "6" seconds
        Then I select the facility "Co-Work@1"
        And I enter "2018-06-2 08:10:00" in the "Start date" field
        And I enter "2018-06-2 18:20:00" in the "End Date" field
    ...
    Scenario: Verify Valid Start Time & End Time-> Booking a Conference Room Offline
        ...
        And I wait "8" seconds
        Then I select the facility "conf CMR"
        And I enter "2018-07-14 17:00:00" in the "Start date" field
        And I wait "3" seconds
        And I enter "2018-07-14 18:00:00" in the "End Date" field
        And I click the "Start date" element
...
#        And I click "OK" in the confirmation box
    ...
    Scenario: Verify Replan Start Time & End Time-> Booking a Conference Room Facility Offline
        ...
        And I wait "8" seconds
        Then I select the facility "conf CMR"
        And I enter "2018-07-15 18:10:00" in the "Start date" field
        And I enter "2018-07-15 18:20:00" in the "End Date" field
        And I click the "Start date" element
        And I wait "3" seconds
        And I click the "BookNow" button
    ...
    Scenario: Verify Invalid Start Time & End Time-> Booking a Conference Room Facility Offline
        ...
        And I wait "8" seconds
        Then I select the facility "conf CMR"
        And I enter "2018-05-14 17:00:00" in the "Start date" field
        And I enter "2018-05-14 17:00:00" in the "End Date" field
        And I click the "Start date" element
    ...
    Scenario: Verify Valid Start Time & End Time-> Booking a Training Room Facility Offline
        ...
        And I enter "2018-06-14 17:00:00" in the "Start date" field
        And I wait "3" seconds
        And I enter "2018-06-14 18:00:00" in the "End Date" field
        And I click the "Start date" element
        And I click the "BookNow" button
        And I select "offline" from the "Payment Type" radio list
        And I click the "Confirm" button
...
#        And I click "OK" in the confirmation box
    ...
    Scenario: Verify Replan Start Time & End Time-> Booking a Training Room Facility Offline
        ...
        And I wait "8" seconds
        Then I select the facility "training 3"
        And I enter "2018-06-14 18:10:00" in the "Start date" field
        And I wait "3" seconds
        And I enter "2018-06-14 18:20:00" in the "End Date" field
        And I click the "Start date" element
        And I wait "2" seconds
        And I click the "BookNow" button
        And I click the "Replan" button
    ...
    Scenario: Verify Valid Start Time & End Time-> Booking a Meeting Room Facility Offline
        ...
        And I enter "22018-06-14 17:00:00" in the "Start date" field
        And I wait "3" seconds
        And I enter "2018-06-14 18:00:00" in the "End Date" field
        And I click the "Start date" element
        And I wait "2" seconds
...
#        And I click "OK" in the confirmation box
    ...
    Scenario: Verify Replan Start Time & End Time-> Booking a Meeting Room Facility Offline
        ...
        And I wait "8" seconds
        Then I select the facility "meeting 1"
        And I enter "2018-06-15 18:10:00" in the "Start date" field
        And I wait "2" seconds
        And I enter "2018-06-15 18:20:00" in the "End Date" field
        And I click the "Start date" element
        And I click the "BookNow" button
        And I click the "Replan" button
        And I click the "BookNow" button
    ...
    Scenario: Verify Invalid Start Time & End Time-> Booking a Meeting Room Facility Offline
        ...
        And I wait "8" seconds
        Then I select the facility "meeting 1"
        And I enter "2018-05-15 17:00:00" in the "Start date" field
        And I enter "2018-05-15 17:00:00" in the "End Date" field
        And I click the "Start date" element
...
#        And I click the "ChangePassword" element
#        And I enter "password" in the "OldPassword" field
#        And I enter "password4" in the "NewPassword" field
#        And I enter "password4" in the "ConfirmPassword" field
#        And I click the "SaveChanges" button
